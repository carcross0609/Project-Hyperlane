...
Reference database of Star Wars starship types, scraped from
[Wookieepedia's Starship types category](https://starwars.fandom.com/wiki/Category:Starship_types)
(recursively, including all subcategories) on 2026-07-03. Covers both **Canon**
and **Legends** continuities; a handful of individual named ships (e.g. the
*Millennium Falcon*) are included where Wookieepedia files them under a type
category.
