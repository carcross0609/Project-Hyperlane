...
**Continuity:** Canon  
**Source:** [Ghorman](https://starwars.fandom.com/wiki/Ghorman)
**Galaxy atlas:** system `Ghorman`, Colonies, grid L-13 — map position (420.8, -5965.9, -285.6)
...
As a direct result of heavy Imperial control, including an intense propaganda campaign facilitated by the Ministry of Enlightenment, in 2 BBY, a peaceful protest took place against Imperial oppression. However, the demonstration ended in bloodshed, with Imperial troops and droids slaughtering thousands of protesters. The incident became known as the Ghorman Massacre.
...
- **Region:**
  ...
  - The Interior
- **Sector:** Sern sector
- **System:** Ghorman system
- **Coordinates:** L-13
- **Suns:** 1: Ghorman sun
- **Routes:** Rimma Trade Route
- **Class:** Terrestrial
...
- **Fauna:**
  ...
  - Culver
- **Otherspecies:** Humans
- **Socialgroup:** Ghormans
- **Language:** Ghor
- **Population:** 800,000 (by 5 BBY)
- **Demonym:**
  - Ghorman
  - Ghor
- **Cities:**
...
- [Ghorman (Canon)](../../Species/Ghorman%20%28people%29/README.md)
