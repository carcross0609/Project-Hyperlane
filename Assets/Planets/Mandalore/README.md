...
**Continuity:** Canon  
**Source:** [Mandalore](https://starwars.fandom.com/wiki/Mandalore)
**Galaxy atlas:** system `Mandalore`, Outer Rim, grid O-7 — map position (5451.8, 4083.2, -125.7)
...
- **Moons:**
  ...
  - Concordia
  - Mesumika
- **Lengthday:** 19 standard hours
- **Lengthyear:** 366 standard days
- **Class:** Terrestrial
- **Diameter:** 9,200 km (5,716 miles)
- **Atmosphere:** Type I but Inhospitable
- **Climate:**
  - Hot and dry (Before the Purge)
  - Storms (After the Purge)
- **Gravity:** Standard
- **Terrain:**
  - Forests (Historic)
  - Lakes (Historic)
  ...
  - Seas (Historic)
  - Mountains (Historic)
  - Deserts (Before the Purge)
  - Domed cities (Before the Purge)
  - Crystals (After the Purge)
  - Glass (After the Purge)
  - Trinitite (After the Purge)
  - Caverns (After the Purge)
- **Interest:**
  - Great Forge
  - Mandalore Imperial base
  - Mandalore prison outpost
...
- **Language:**
  ...
  - Mando'a
- **Government:**
  - Clans under the authority of the Mand'alor
  - Mandalorian Government Council (during the Republic Era)
  - Governorship (during the Imperial Era)
- **Population:**
  - 4,000,000 (Pre-Purge)
  -   81% humans
  -   19% other
...
- **Demonym:** Mandalorian
- **Cities:**
  - Keldabe (former capital)
  - Ronion
  - Sundari (capital)
- **Imports:** Raw materials
- **Exports:** Mercenaries, starships
- **Affiliation:**
  - New Mandalorians
  - Galactic Republic
  - Shadow Collective
...
- [Alamite (Canon)](../../Species/Alamite/README.md)
